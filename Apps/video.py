...
# start webcam
cap = cv.VideoCapture(r'/home/herfandi/NN/Apps/Video_test.mp4.mp4')
...
out = cv.VideoWriter(r'/home/herfandi/NN/Apps/videos/Video_Result.mp4', fourcc, fps, (width, height))
# model
model = YOLO(r"/home/herfandi/NN/Apps/models/best.pt")
char_detect = tf.keras.models.load_model(r'/home/herfandi/NN/Apps/models/model128.h5')
# object classes
