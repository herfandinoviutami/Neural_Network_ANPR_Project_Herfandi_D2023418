...
# start webcam
cap = cv.VideoCapture(r'D:\NN_New\skripsi_documentation\yolo\Video_test.mp4')
...
out = cv.VideoWriter(r'D:\NN_New\skripsi_documentation\yolo\videos\Video_Result20.mp4', fourcc, fps, (width, height))
# model
model = YOLO(r"D:\NN_New\skripsi_documentation\yolo\models\best.pt")
char_detect = tf.keras.models.load_model(r'D:\NN_New\skripsi_documentation\07_model_cnn\char_model.h5')
# object classes
            ...
            for contour in contours:
                ...
                if 1<=ratio<=3.5:
                    if h/plate_img.shape[0]>=0.3:
                        cv.rectangle(plate_img, (x, y), (x + w, y + h), (0, 0, 255), thickness=3)
                        if frame_count % 10 == 0:
                            cv.imwrite(f'process/segmentasi/frame_segmentasi_{frame_count}.jpg', plate_img)
